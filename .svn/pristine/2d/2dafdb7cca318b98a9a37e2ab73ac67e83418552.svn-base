...
//				 System.out.println("Group number:" + i);
			...
			// + sitestring + "%'");
			metaquery
					.append("select se_id,url,dscore from metaurldetails,to_tsquery('");
			...
			metaquery.append("') q where term @@ q order by dscore desc;");
...
//			}
			...
			while (mets_rs.next() && z <= 20) {
				...
				out.print("<tr><td>" + z + "</td> <td> Group "
						+mets_rs.getInt(1)+ "</td> <td padding: 5px;><a href=#>"
