	...
	public void create() {
		...
		try {
			...
			if (conn != null) {
				...
				String jaccardtable = "CREATE TABLE IF NOT EXISTS jaccardsim(from_docid integer,to_docid integer,jaccard_sim float, min1 float,min4 float,min16 float,min32 float,abserrormin1 float,abserrormin4 float,abserrormin16 float,abserrormin32 float)";
